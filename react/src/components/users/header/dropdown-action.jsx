    ...
    <Dropdown className="custom-dropdown dropdown-action">
      ...
      <Dropdown.Menu className="">
        <Dropdown.Item
          ...
          href="#/action-1"
        >
          <Image src={iconDashboard} /> Dashboard{" "}
        </Dropdown.Item>
        <Dropdown.Item
          className="d-flex gap-10 align-items-center"
          href="#/action-2"
        >
          <Image src={iconOrder} /> Đơn hàng{" "}
        </Dropdown.Item>
        <Dropdown.Item
          className="d-flex gap-10 align-items-center"
          href="#/action-3"
        >
          <Image src={iconProduct} /> Sản phẩm
        </Dropdown.Item>
        <Dropdown.Item
          className="d-flex gap-10 align-items-center"
          href="#/action-3"
        >
          <Image src={iconLogout} /> Chuyển đổi tài khoản{" "}
        </Dropdown.Item>

        <Dropdown.Item className="btn" href="#/action-3">
          NÂNG CẤP gian hàng
        </Dropdown.Item>
      </Dropdown.Menu>
    </Dropdown>
