          ...
          <Row className="align-items-center">
            ...
            <Col xl={5}>
              <div className="content">
                ...
                <TextDescription
                  className="mt-24"
                  text="Chúng tôi hướng đến việc tạo ra các kết nối mang lại giá trị không chỉ trong giao thương mà còn trong mối quan hệ và sự phát triển bền vững"
                ></TextDescription>
                ...
                <ul className="mt-26">
                  <li className="d-flex gap-10">
                    ...
                    <div>
                      ...
                      <TextDescription
                        text="Bằng cách kết nối với các đối tác trên toàn thế giới, bạn có cơ hội tiếp cận vào các thị trường mới và mở rộng phạm vi kinh doanh của mình."
                        className="mt-10"
                      ></TextDescription>
                    </div>
                  </li>
                  ...
                  <li className="d-flex gap-10 mt-26">
                    ...
                    <div>
                      ...
                      <TextDescription
                        text="Việc xây dựng các mối quan hệ với các đối tác không chỉ mang lại lợi ích ngắn hạn mà còn tạo ra cơ hội cho sự phát triển bền vững và hợp tác lâu dài."
                        className="mt-10"
                      ></TextDescription>
                    </div>
                  </li>
